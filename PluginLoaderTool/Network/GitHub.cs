...
namespace avaness.PluginLoaderTool.Network
{
    public static class GitHub
    {
        ...
        public static void Init()
        {
            ...
            {
                Console.WriteLine("An error occurred while setting up networking, web requests will probably fail: " + e);
            }
        }
        ...
        public static async Task<Stream> DownloadRepoAsync(string name, string commit)
        {
        ...
        public static async Task<Stream> DownloadFileAsync(string name, string commit, string path)
        {
