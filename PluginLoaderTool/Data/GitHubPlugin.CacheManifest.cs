        ...
        public class CacheManifest
        {
            ...
            private void Init(string cacheDir)
            {
                ...
                if(File.Exists(oldCommitFile))
                {
                    ...
                    {
                        Console.WriteLine("Error while reading old commit file: " + e);
                    }
                }
            }
            ...
            {
                string cacheDir = Path.Combine(Program.ParsedOptions.SteamDir, "Plugins", "GitHub", userName, repoName);
                ...
                else
                {
                    ...
                    {
                        Console.WriteLine("Error while loading manifest file: " + e);
                        manifest = new CacheManifest();
                    }
                }
            ...
            public void Save()
            {
                ...
                {
                    Console.WriteLine("Error while saving manifest file: " + e);
                }
            }
